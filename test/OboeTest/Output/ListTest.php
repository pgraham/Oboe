...
/**
 * This class tests the output of the Oboe_List class.
 *
 * @author Philip Graham <philip@lightbox.org>
 * @package OboeTest
 * @subpackage Output
 */
class OboeTest_Output_ListTest extends PHPUnit_Framework_TestCase {

    public function testAddListItem() {
        $list = new Oboe_List(Oboe_BaseList::UNORDERED);

        $toAdd = new Oboe_ListItem('YAY');
        $li = $list->add($toAdd);
    ...
    public function testAddByConstructorArgs() {
        ...
        $li = $list->add('YAY');
        $this->assertEquals('Oboe_ListItem', get_class($li),
