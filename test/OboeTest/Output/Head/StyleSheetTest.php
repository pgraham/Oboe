 ...
 * @subpackage Output
 */
class OboeTest_Output_Head_StyleSheetTest extends PHPUnit_Framework_TestCase {

    public function testOutput() {
        $sheet = new Oboe_Head_StyleSheet('/css/style.css');
        $output = preg_replace('/[\n\t]/', '', $sheet->__toString());
        ...
        $sheet = new Oboe_Head_StyleSheet('/css/style.css', 'print');
        $output = preg_replace('/[\n\t]/', '', $sheet->__toString());
        $expected = '<link rel="stylesheet" href="/css/style.css" '.
