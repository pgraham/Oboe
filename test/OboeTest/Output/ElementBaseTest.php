 ...
 * @subpackage Output
 */
class OboeTest_Output_ElementBaseTest extends PHPUnit_Framework_TestCase {

    public function testBasicOutput() {
        $mock = new OboeTest_Mock_ElementBase();
    ...
    public function testConstructorArgs() {
        $mock = new OboeTest_Mock_ElementBase('theMock', 'mockElement');
    ...
    public function testIdGetSet() {
        $mock = new OboeTest_Mock_ElementBase('notTheMock');
    ...
    public function testClassGetSet() {
        $mock = new OboeTest_Mock_ElementBase(null, 'notAMockElement');
