 ...
 * @package Oboe
 */
class Oboe_Style extends Oboe_ElementComposite implements Oboe_Item_Head,
    Oboe_Item_Body
{
    ...
    public function __construct() {
        ...
        $this->_objectTypes = array('Oboe_Style_Rule');
        $this->_rules = array();
    }
     ...
     *
     * @param mixed Either a Oboe_StyleRule or a string selector of a style
     *     rule, if a Oboe_StyleRule object is provided it will override any
     ...
     *     this can either be a Oboe_StyleProperty to add to the rule or the
     ...
     * @return Oboe_StyleRule The object that was added
     */
    public function add($rule, $property = null, $value = null) {
        if ($rule instanceof Oboe_Style_Rule) {
            ...
            if (array_key_exists($rule, $this->_rules)) {
                ...
                $ruleObj = new Oboe_Style_Rule($rule);
            ...
            if ($property instanceof Oboe_Style_Property) {
                ...
                $ruleObj->add(new Oboe_Style_Property($property, $value));
            }
            return $ruleObj;
        }
    }
