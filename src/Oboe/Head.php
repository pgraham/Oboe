 ...
 * @package Oboe
 */
class Oboe_Head extends Oboe_ElementComposite {
    ...
    protected function __construct() {
        ...
        $this->_objectTypes = array('Oboe_Item_Head');
    ...
    public function __toString() {
        if ($this->_title !== null) {
            $this->add(new Oboe_Head_Title($this->_title),
                Oboe_ElementComposite::UNSHIFT);
        }
