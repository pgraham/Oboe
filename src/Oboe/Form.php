 ...
 * @package Oboe
 */
class Oboe_Form extends Oboe_ElementWrapper implements Oboe_Item_Body {
    ...
    public function __construct($name, $action = null, $method = 'post') {
        ...
        $this->_container = new Oboe_Form_Div(null, self::DIV_CSS_CLASS);
        $this->_objectTypes = array('Oboe_Form_Div');
     ...
     * @return Oboe_Text_VSpace The element that was added
     */
    public function addBreak($num = 1) {
        $vSpace = new Oboe_Text_VSpace();
        for ($i = 0; $i < $num; $i++) {
            $this->add($vSpace);
        }
        return $vSpace;
     ...
     * @return Oboe_Divider The element that was added
     */
