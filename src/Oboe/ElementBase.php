 ...
 * @package Oboe
 */
abstract class Oboe_ElementBase implements Oboe_Item_Document {
     ...
     * Oboe_Item_Body interface.
     */
    public function addToBody() {
        Oboe_Page::addElementToBody($this);
    }

    /**
     * This method adds the element to the <head> element.  In order for this
     * method to work the implementing class needs to implement the
     * Oboe_Item_Head interface.
     */
    public function addToHead() {
        Oboe_Page::addElementToHead($this);
    }
     ...
     */
    protected static function openTag(Oboe_ElementBase $element) {
     ...
     */
    protected static function closeTag(Oboe_ElementBase $element) {
        $tabs = Oboe_Text_Tabs::getTabs();
     ...
     */
    private static function _buildStyleString(Oboe_ElementBase $element) {
        $style = '';
