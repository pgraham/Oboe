 ...
 * @subpackage Form
 */
class Oboe_Form_Select extends Oboe_ElementComposite implements Oboe_Item_Form {
    ...
    public function __construct($name) {
        ...
        $this->_objectTypes = array('Oboe_Form_SelectOption');
    ...
    {
        if ($element instanceof Oboe_Form_SelectOption) {
            parent::add($element, $push);
            return $element;
        }

        $opt = new Oboe_Form_SelectOption($element, $lbl, $selected);
        parent::add($opt, $push);
        return $opt;
    }
}
